...
chrome.spawn = function(options) {
	return new Promise((resolve, reject) => {
		...
		this.chromeChild = spawn(location, this.options.chromeFlags || ['--disable-web-security', '--no-sandbox', '--headless', '--disable-gpu', '--remote-debugging-port=9222', '--hide-scrollbars']);
